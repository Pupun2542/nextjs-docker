            ...
            return docref
                ...
                .then((ref) => {
                  ...
                  sendNotifications(
                      ...
                      req.params.gid,
                      "",
                      `group/${req.params.gid}/dashboard?pid=${req.params.pid}&cid=${req.params.cid}&rid=${ref.id}`,
                      req.body.mention.length > 0?
                    {
                      priorityTarget: req.body.mention.map(
                          (tgt) => tgt.parentId,
                      ),
                      specialPayload: {
                        mention: req.body.mention,
            ...
            return docref
                ...
                .then(() => {
                  sendNotifications(
                      ...
                      req.params.gid,
                      "",
                      `group/${req.params.gid}/dashboard?pid=${req.params.pid}&cid=${req.params.cid}&rid=${req.params.rid}`,
                  );
