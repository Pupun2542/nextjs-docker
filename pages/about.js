...
import { Box, Flex, Image, Spacer, VStack, Heading, Center, Stack, Text, HStack, Divider, SimpleGrid } from '@chakra-ui/react'
          ...
          >
            ...
            <SimpleGrid spacing={5} columns={3} pr={5} pl={5} pb={5}>
              ...
              >
                ...
                <Center h={55} pl={3} fontSize={18}>Discord</Center>
              </Flex>
            ...
            <SimpleGrid columns={3} p={5} spacing={10}>
              ...
              <Flex direction={'column'}>
                ...
                >
                  <Center w={'100%'}>
                    <Image rounded={'full'} src='CV.jpg' height={100} width={100}></Image>
                  </Center>
              ...
              <Flex direction={'column'}>
                ...
                >
                  <Center w={'100%'}>
                    <Image rounded={'full'} src='natthara.png' height={100} width={100}></Image>
                  </Center>
              ...
              <Flex direction={'column'}>
                ...
                >
                  <Center w={'100%'}>
                    <Image rounded={'full'} src='mm.png' height={100} width={100}></Image>
                  </Center>
            ...
            <Center
              ...
              p={10}
            >
              ขอขอบคุณทุกท่านที่สนับสนุนพวกเรา!</Center>
          </Flex>
          <Box bg={'#6768AB'} h={200} w={200} mt={200}></Box>
        </Flex>
      </Flex>
